...
Le interviste, come detto precedentemente, si sono svolte sia in presenza che da remoto, ma sempre singolarmente.
...
di registrare visivamente come utilizzano l'attuale applicativo. Tramite questa modalità si è potuto captare i flussi di utilizzo e 
...
delle interviste precedenti alle successive. In questo modo si potuto distillare quali bisogni erano i più condivisi.
Questo approccio ha consentito inoltre di ordinandare i requisiti per importanza.
...
Nelle interviste si è cercato di raccogliere richieste che, anche in fase di primo rilascio,
...
\begin{itemize}
    ...
    \item Importazione dal \ac{PLM} di dati tecnici dei prodotti. Questi dati sono utili nei calcoli utili alla contrattazione (Es: Potenza elettrica totale consumata).
