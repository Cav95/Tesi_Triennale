...
% Gestione degli spazi non interrompibili invisibili (U+00A0)
...
% Document metadata
\title{\textbf{Riassunto dei capitoli proposti della tesi di laurea}}
...
% --- Abstract ---
\begin{abstract}
\noindent La tesi verte sulla progettazione di un nuovo CPQ (\textit{Configure, Price, Quote}) per l'azienda \textit{Cepi S.p.A.}, con l'obiettivo di sostituire il vecchio programma sviluppato in Microsoft Access.
\end{abstract}
...
\newpage
\section{Modulo collegamento viewModel e model}
