...
L' analisi è stata condotta inizialmente con una selezione di figure chiave quali scelte per mansione o/e ruolo ,che potessero
dare una visione dei bisogni del proprio o con altrui reparto e successivamente sottoponendoli ad interviste.
Le interviste e, in certi casi demo dell'attaule mezzo utilizzato ,hanno fatto emergere attuali e nuove necessità 
architteturali da affrontare come il cross-platform, l'utilizzo offline del database e la necessità di costrurire offerte in modo più agile e strutturato.
...
sono state pensate in ottica mobile first per rendere l'utilizzo agile da dispositivi mobile.
Le difficoltà incrontate nelle fasi preliminari erano state alla scelta più accurata dei Framework e le strutture dati
per garantire al richiedente un sistema che non rischiasse il debito tecnico e che potesse essere usato a lungo.
